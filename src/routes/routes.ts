import { DynamicFormPage, FormiBasicPages, FormikAbtract, FormikCompounents, FormiYupPages, RegisterPage,  RegisterPageFormikMode} from "../03-forms/pages";
...
export const routes: RouteData[] = [
    ...
    {to: '/Register-Page-Formik-Page', path:'Register-Page-Formik-Page', Component: RegisterPageFormikMode, name: 'Register whit Formik' },
    {to: '/Dynamic-Form-Page', path:'Dynamic-Form-Page', Component: DynamicFormPage, name: 'Dynamic Form Page' },
